...
$repo = "drift-model-explain-grid"
$language = "Haskell"
$category = "ML utilities"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/drift-model-explain-walkthrough.md")) {
