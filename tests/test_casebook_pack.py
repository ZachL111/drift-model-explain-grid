"""Regression checks for the drift-model-explain-grid casebook."""
...
from casebook.harness import assert_expected, drift_model_explain_grid_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(drift_model_explain_grid_summary(), assert_expected())
