...
drift-model-explain-grid is a Haskell project for ml utilities. It focuses on this technical goal: Create a Haskell reference implementation for explain workflows, centered on visual model generation, layout fixtures, and stable geometry snapshots.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 153, risk penalty 6, latency penalty 3, and weight bonus 3. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
